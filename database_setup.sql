-- ============================================
-- ChatGPT Auto Bot - Database Setup Script
-- ============================================
-- Run this SQL script in your Supabase SQL Editor
-- to create all necessary tables and sample data
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_payments_account ON payments(account_email);
...
CREATE INDEX IF NOT EXISTS idx_card_bins_number ON card_bins(bin_number);
...
CREATE INDEX IF NOT EXISTS idx_proxies_url ON proxies(proxy_url);
CREATE INDEX IF NOT EXISTS idx_proxies_active ON proxies(is_active);
CREATE INDEX IF NOT EXISTS idx_proxies_country ON proxies(country);

-- 5. Korean Addresses Table
...
CREATE INDEX IF NOT EXISTS idx_korean_addresses_city ON korean_addresses(city);
CREATE INDEX IF NOT EXISTS idx_korean_addresses_active ON korean_addresses(is_active);
...
-- ============================================
-- Sample Data: 100 Korean Addresses
-- ============================================

INSERT INTO korean_addresses (line1, line2, city, postal_code, state) VALUES
('128, Jong-ro', 'Kyobo Building', 'Seoul', '03154', 'Seoul'),
...
-- Run this to clean old logs (older than 30 days)
-- ============================================
...
UNION ALL
SELECT 'card_bins', COUNT(*) FROM card_bins
UNION ALL
SELECT 'proxies', COUNT(*) FROM proxies
UNION ALL
SELECT 'korean_addresses', COUNT(*) FROM korean_addresses
UNION ALL
...
-- 2. Run: python bot_main.py
-- 3. Bot will automatically use these tables
-- ============================================
